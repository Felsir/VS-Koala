...
exports.KoalaEditorProvider = void 0;
const vscode = require("vscode");
class KoalaEditorProvider {
    static register(context) {
        const provider = new KoalaEditorProvider(context);
        return vscode.window.registerCustomEditorProvider('koala.viewer', provider);
    }
    constructor(context) {
...
exports.KoalaEditorProvider = KoalaEditorProvider;
//# sourceMappingURL=KoalaEditorProvider.js.map